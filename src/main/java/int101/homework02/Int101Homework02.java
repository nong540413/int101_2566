...
public class Int101Homework02 {
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to use 2.6-2.10
        ...
        Person kan = new Person("Thanawat", "Cauynukul");
        Person gun = new Person("Kan", "kk");

        System.out.println( "----------2.7----------");
        System.out.println(kan.toString());
        System.out.println(gun.toString());
        System.out.println( "----------2.8----------");
        System.out.println("kan's firstName: " + kan.getFirstName());
        System.out.println("kan's lastName: " + kan.getLastName());
        System.out.println("kan's ID: " + kan.getId());
        System.out.println( "----------2.9----------");
        System.out.println("Change kan's firstName to null: ");
        try {
            kan.setFirstName(null);
        } catch (Exception e) {
            System.out.println("Error appeared: " + e.toString());
        }
        System.out.println("Change kan's firstName to thanawat: ");
        kan.setFirstName("thanawat");
        System.out.println("kan's firstName: " + kan.getFirstName());

        System.out.println("Change kan's lastName to null: ");
        try {
            kan.setLastName(null);
        } catch (Exception e) {
            System.out.println("Error appeared: " + e.toString());
        }
        System.out.println("Change Nine's lastName to Cauynukul: ");
        kan.setLastName("Cauynukul");
        System.out.println("kan's firstName: " + kan.getLastName());
        System.out.println( "----------2.10----------");
        System.out.println("kan equals kan: " + kan.equals(kan));
        System.out.println("gun equals gun: " + gun.equals(gun));
        System.out.println("kan equals gun: " + kan.equals(gun));
        System.out.println("gun equals kan: " + gun.equals(kan));
    }
    ...
    static void work03Account() {
       ...
       3.13 Show in this "work03Account" method how to use 3.6-3.12
        ...
        Person nine = new Person("Thanawat", "Cauynukul");
        Account kanAccount = new Account(nine);
        System.out.println("kan account has been created.");

        System.out.println( "----------3.7----------");
        System.out.println("kan account's balance: " + kanAccount.getBalance() + "$");
        System.out.println("kan account's no: " + kanAccount.getNo());
        System.out.println("kan account's owner: " + kanAccount.getOwner());
        System.out.println( "----------3.8----------");

        try {
            System.out.println(kanAccount.deposit(-1));
        } catch (Exception e) {
            System.out.println(e);
        }

        System.out.println("kan account's balance (deposit 500): " + kanAccount.deposit(500));
        System.out.println( "----------3.9----------");

        try {
            System.out.println(kanAccount.withdraw(-1));
        } catch (Exception e) {
            System.out.println(e);
        }

        System.out.println("kan account's balance (withdraw 100): " + kanAccount.withdraw(100));
        System.out.println( "----------3.10----------");
        Person kan = new Person("Kan", "gun");
        Account gunAccount = new Account(kan);

        try {
            kanAccount.transfer(100, null);
        } catch (Exception e) {
            System.out.println(e);
        }

        kanAccount.transfer(100, gunAccount);

        System.out.println("gun account's balance: " + gunAccount.getBalance());
        System.out.println("kan account's balance: " + kanAccount.getBalance());

        System.out.println( "----------3.11----------");
        System.out.println(kanAccount.toString());
        System.out.println(gunAccount.toString());
        System.out.println( "----------3.12----------");
        System.out.println("kan's account equals kan's account: " + kanAccount.equals(kanAccount));
        System.out.println("gun's account equals gun's account: " + gunAccount.equals(gunAccount));
        System.out.println("kan's account equals kan's account: " + kanAccount.equals(gunAccount));
        System.out.println("gun's account equals gun's account: " + gunAccount.equals(kanAccount));
    }
}